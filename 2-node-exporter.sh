...
git clone https://github.com/prometheus/node_exporter/releases/download/v${NODE_EXPORTER_VERSION}/node_exporter-v${NODE_EXPORTER_VERSION}.linux-amd64.tar.gz
